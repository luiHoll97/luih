import { FaClipboard, FaSun, FaBook, FaTicketAlt, FaCheckDouble } from "react-icons/fa";
...
export const Projects: Project[] = [
    ...
    },
    {
      ...
      },
      {
        id: '10',
        title: "mobx todo",
        description: 'Todo app using mobX and redux (for comparison purposes). This uses the immer-todo CSS template',
        image: FaCheckDouble,
        techs: ["React", 'MobX'],
        link: '',
        status: false,
      ...
      },
      {
        id: '11',
        title: "rollup redux",
        description: 'A project I built during a tech test. 20mins to create a simple redux app',
        image: FaCheckDouble,
